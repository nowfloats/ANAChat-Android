...
//        bounceDotRadius = dotRadius + (dotRadius / 3);
    ...
    private void initializeAttributes(AttributeSet attrs) {
        if (attrs != null) {
            ...
            try {
                ...
                setStartColor(
                        a.getInteger(
                                ...
                                lightenColor(PreferencesManager
                                        .getsInstance(getContext()).getThemeColor())
                        )
                );
                ...
                setEndColor(
                        a.getInteger(
                                ...
                                Color.parseColor(PreferencesManager
                                        .getsInstance(getContext()).getThemeColor())
                        )
                );
            ...
            setStartColor(lightenColor(PreferencesManager
                    .getsInstance(getContext()).getThemeColor()));
            setEndColor(Color.parseColor(PreferencesManager
                    .getsInstance(getContext()).getThemeColor()));
    ...
    private int lightenColor(String v) {
        return adjustAlpha(Color.parseColor(v), 0.5f);
    }
